<template>
    <div class="w-full md:w-1/2 mx-auto md:min-h-screen">
        ...
        <template v-if="articles.length">
            <div v-for="article in articles" class="rounded-lg overflow-hidden mt-10">
                <div class="bg-green-500 p-5" v-if="article.attributes.img">
                    <nuxt-link :to="(article.attributes.online == 'true') ? '/articles/' + article.attributes.url : ''">
                ...
                <div class="py-4 px-8 bg-gray-100 text-black">
                    ...
                    <div class="mt-8 text-right">
                        <template v-if="article.attributes.online == 'true'">
