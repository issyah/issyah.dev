<template>
    <div class="death-star-container" :style="getTransforms">
        <svg class="inline death-star" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        	 viewBox="0 0 196.797 196.797" style="enable-background:new 0 0 196.797 196.797; width:500px;" xml:space="preserve">
        <path fill="currentColor" d="M98.398,196.797c-14.117,0-27.551-2.989-39.699-8.366c-0.207-0.055-0.4-0.143-0.575-0.257
